...
use App\Filament\Resources\MobilePhonesResource\Pages;
use App\Filament\Resources\MobilePhonesResource\RelationManagers;
...
class MobilePhonesResource extends Resource
{
    protected static ?string $model = MobilePhones::class;

    protected static ?string $navigationIcon = 'icon-mobile';
    ...
    {
        return [
            'index' => Pages\ListMobilePhones::route('/'),
            'create' => Pages\CreateMobilePhones::route('/create'),
            'edit' => Pages\EditMobilePhones::route('/{record}/edit'),
        ];
    }
}
